                    ...
                    <div class="col-md-3">
                        <div class="form-group">Transaction Date:       
                            <div class="input-group date date-picker" style="width:80%" data-date-format="yyyy-mm-dd">
                                <input type="text" class="form-control form-filter" readonly name="docdate" id="docdate" value="<?php echo e(request()->has('docdate') ? request()->docdate : date('Y-m-d')); ?>">
                    ...
                    <div class="col-md-6" style="text-align: right;">
                        <div class="form-group">
                            <?php if(count($transactions)): ?> 
                                <form method="POST" action="<?php echo e(route('transaction-batch-per-date.update', request()->docdate)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
                                    <input type="hidden" name="seq" value="<?php echo e(request()->docdate); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webfocusprod/cms4.webfocusprod.wsiph2.com/pmc_p1/PMCP1-OMWS/PMC-OMWS/resources/views/pages/transactions/post-per-date.blade.php ENDPATH**/ ?>