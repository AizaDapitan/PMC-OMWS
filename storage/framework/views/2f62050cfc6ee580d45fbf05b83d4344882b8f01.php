...
<?php $__env->startSection('content'); ?>
            ...
            <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="direction:rtl;">
                        <div class="btn-group">
                            <a onclick="return confirm('Are you sure you want to run reindexing?')" href="<?php echo e(route('maintenance.application.create_indexing')); ?>" class="btn sbold green"> Reindex Application Database</a>                                                    
                        </div>
                        <div class="btn-group">
                            <a onclick="return confirm('Are you sure you want to start application?')" href="<?php echo e(route('maintenance.application.systemUp')); ?>" class="btn sbold blue"> Start</a>                                                    
                        </div>
                        <div class="btn-group">
                            <a onclick="return confirm('Are you sure you want to stop application?')" href="<?php echo e(route('maintenance.application.systemDown')); ?>" class="btn sbold red"> Stop</a>                                                    
                        </div>
                    </div>
                </div>
                </div>    
                    ...
                    <table class="table table-striped table-hover" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr>                              
                                <td><?php echo e($application['scheduled_date']); ?></td>
                                <td><?php echo e($application['scheduled_time']); ?></td>
                                <td><?php echo e($application['reason']); ?></td>
                                <td class="text-center">
                                    <?php if($edit): ?>
                                        <a onclick="getApplicationDetails(<?php echo $application['id']; ?>)" data-toggle="modal" data-target="#basic"  class="btn btn-sm blue btn-outline filter-submit margin-bottom"><i class="fa fa-edit"></i> Edit</a>
                                        <a data-toggle="modal"  class="btn btn-sm red btn-outline filter-submit margin-bottom" href="#remove<?php echo e($application['id' ]); ?>"><span class="fa fa-trash-o"></span> Remove</a>
                                    <?php else: ?>
	...
	<div class="modal fade" id="basic" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="form" role="form" action="<?php echo e(route('maintenance.application.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="remove<?php echo e($application['id']); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="<?php echo e(route('maintenance.application.destroy', $application['id'])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
$(document).ready(function(){                
        ...
        function addSchedule() {
          ...
          $('#method').val('POST');
          $('#form').attr('action', '<?php echo e(route('maintenance.application.store')); ?>');
      }
  
          function getApplicationDetails(id) {
              $.ajax({
                  url: '<?php echo route('maintenance.application.edit'); ?>',
                  type: 'POST',
                  async: false,
                  dataType: 'json',
                  data:{
                  ...
                  success: function(response){
                      ...
                      $('#id').val(id);                
                      $('#method').val('PUT');
                      $('#form').attr('action', '<?php echo e(route('maintenance.application.update')); ?>');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PERSONAL\SC\PMC PROJECT\omws\resources\views/pages/application.blade.php ENDPATH**/ ?>