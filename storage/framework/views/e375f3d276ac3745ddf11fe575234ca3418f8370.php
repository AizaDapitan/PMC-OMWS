...
<div class="col-md-12">
<div class="row">
<h3 class="page-title"> Issuance Report By Status - <?php echo e(ucfirst(request()->status)); ?> </h3>

<form action="<?php echo e(route('rpt.issuance-by-status')); ?>" method="get">
...
$q = "&".$q_string[1];
?>
<a href="<?php echo e(route('rpt.issuance-by-status')); ?>?excel=true<?php echo e($q); ?>" target="_blank" class="btn green"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
<a href="<?php echo e(route('rpt.issuance-by-status')); ?>?print=true<?php echo e($q); ?>" target="_blank" class="btn purple"><i class="fa fa-print"></i> &nbsp;&nbsp;Print&nbsp;&nbsp;&nbsp;&nbsp;</a>
</div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webfocusprod/cms4.webfocusprod.wsiph2.com/pmc_p1/PMCP1-OMWS/PMC-OMWS/resources/views/pages/reports/transaction-by-status.blade.php ENDPATH**/ ?>