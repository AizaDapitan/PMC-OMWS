        ...
        <div class="col-md-12">
            ...
            <ul class="page-breadcrumb breadcrumb">
                <li> 
                    ...
                    <?php else: ?>
                        <button disabled class="btn blue" data-toggle="modal" data-backdrop="static" href="#modalItemAdd" style="color:white;">Add New</button>
                    <?php endif; ?>
                </li>
            </ul>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($edit): ?>
                                                <a class="edit_item" data-toggle="modal" data-backdrop="static" href="#modalItemEdit" 
                                                ...
                                                data-category="<?php echo e($item->category); ?>" data-ucost="<?php echo e($item->unit_cost); ?>"> <i class='fa fa-pencil'></i> </a>
                                            <?php else: ?>
                                                <button disabled class="edit_item" data-toggle="modal" data-backdrop="static" href="#modalItemEdit" 
                                                data-href="<?php echo e(route('items.update', $item->id)); ?>" data-code="<?php echo e($item->code); ?>"
                                                data-name="<?php echo e($item->name); ?>" data-uom="<?php echo e($item->uom); ?>" 
                                                data-category="<?php echo e($item->category); ?>" data-ucost="<?php echo e($item->unit_cost); ?>"> <i class='fa fa-pencil'></i> </button>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PERSONAL\SC\PMC PROJECT\omws\resources\views/pages/items/index.blade.php ENDPATH**/ ?>