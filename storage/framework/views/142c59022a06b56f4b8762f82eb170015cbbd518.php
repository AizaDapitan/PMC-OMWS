                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $sequences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sequence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td> <?php if(\Auth::user()->can_open_sequence): ?> <button class="btn btn-primary btnToggleAction" data-id="<?php echo e($sequence->id); ?>"><?php echo e($sequence->is_open ? 'Close':'Open'); ?></button> <?php endif; ?> 
                                            <?php if($sequence->is_fabricated == 1): ?> <button class="btn btn-warning editfabricatednum" href="#fabricatedseqnumedit" data-id="<?php echo e($sequence->id); ?>" data-seqnum="<?php echo e($sequence->sequence_id); ?>"> EDIT </button> <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\owms_v2\resources\views/pages/sequence/index.blade.php ENDPATH**/ ?>