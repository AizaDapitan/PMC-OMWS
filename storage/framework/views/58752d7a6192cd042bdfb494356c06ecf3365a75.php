...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="row">
                    <form action="<?php echo e(route('rpt.item-issuance-details')); ?>" method="get">
                ...
                <div class="row">
                    <?php 
                        ...
                        if(count($q_string) > 1)
                            $q = "&".$q_string[1];
                    ?>
                    <a href="<?php echo e(route('rpt.item-issuance-details')); ?>?excel=true<?php echo e($q); ?>" target="_blank" class="btn green"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
                    <a href="<?php echo e(route('rpt.item-issuance-details')); ?>?print=true<?php echo e($q); ?>" target="_blank" class="btn purple"><i class="fa fa-print"></i> &nbsp;&nbsp;Print&nbsp;&nbsp;&nbsp;&nbsp;</a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webfocusprod/cms4.webfocusprod.wsiph2.com/pmc_p1/PMCP1-OMWS/PMC-OMWS/resources/views/pages/reports/item-issuance-details.blade.php ENDPATH**/ ?>