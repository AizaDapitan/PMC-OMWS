...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form method="POST" action="<?php echo e(route('updatePassword')); ?>" role="form">
                <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PERSONAL\SC\PMC PROJECT\omws\resources\views/pages/profile/change-pass.blade.php ENDPATH**/ ?>