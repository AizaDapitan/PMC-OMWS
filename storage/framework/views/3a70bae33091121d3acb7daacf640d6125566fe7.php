...
href="#modalEdit" data-href="<?php echo e(route('maintenance.contractors.update', $contractor->id)); ?>"
data-fname="<?php echo e($contractor->fname); ?>" data-lname="<?php echo e($contractor->lname); ?>" data-mname="<?php echo e($contractor->mname); ?>" data-code="<?php echo e($contractor->code); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webfocusprod/cms4.webfocusprod.wsiph2.com/pmc_p1/PMCP1-OMWS/PMC-OMWS/resources/views/pages/contractors/index.blade.php ENDPATH**/ ?>