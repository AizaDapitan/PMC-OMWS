                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    @if($edit)
                                    <a data-toggle="modal" class="edit_item" data-backdrop="static" href="#modalEdit" data-href="{{ route('maintenance.contractors.update', $contractor->id) }}" data-fname="{{ $contractor->fname }}" data-lname="{{ $contractor->lname }}" data-mname="{{ $contractor->mname }}" data-code="{{ $contractor->code }}">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    @else
                                    <button disabled data-toggle="modal" class="edit_item" data-backdrop="static" href="#modalEdit" data-href="{{ route('maintenance.contractors.update', $contractor->id) }}" data-fname="{{ $contractor->fname }}" data-lname="{{ $contractor->lname }}" data-mname="{{ $contractor->mname }}" data-code="{{ $contractor->code }}">
                                        <i class="fa fa-pencil"></i>
                                    </button>
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    @else
                                    <button disabled type="button" class="btn blue btn-xs add_location" data-id="{{ $contractor->id }}">Go</button>
                                    @endif
                                </td>
                            </tr>
                            @empty
